      ...
      <div className="row justify-content-center animate-fade-in-up">
        <div className="col-lg-6 col-xl-5">
          ...
          >
            ...
            <h4 className="fw-bold mb-0" style={{ color: "#fff", fontSize: "1rem" }}>Membership Access</h4>

            <div className="my-2">
              <span style={{ color: "#87DEFA", fontSize: "0.9rem" }}>$</span>
              <span style={{ color: "#fff", fontSize: "2.8rem", fontWeight: 800 }}>55</span>
            </div>
            ...
            <ul className="list-unstyled mb-3" style={{ textAlign: "left" }}>
              {[
                ...
                <li key={i} className="d-flex align-items-center gap-2 mb-1" style={{ color: "#87DEFA", fontSize: "0.8rem" }}>
            ...
            {onSelect ? (
              <button onClick={onSelect} className="btn btn-neon w-100 py-2" style={{ fontSize: "0.9rem" }}>
                Get Started Now
              </button>
            ) : (
              <Link href="/payment" className="btn btn-neon w-100 py-2" style={{ fontSize: "0.9rem" }}>
                Get Started Now
              </Link>
            )}

            <p className="mt-2 mb-0" style={{ color: "var(--text-muted)", fontSize: "0.7rem", fontStyle: "italic" }}>
